<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="UserManager.aspx.cs" Inherits="UserManager" %>
                ...
                CellPadding="1" CellSpacing="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibtnActive" OnClick="ChangeStatus" runat="server" ImageUrl='<% # Convert.ToBoolean(Eval("IsActive")) ? "~/img/active.gif" : "~/img/inactive.gif" %>' CommandArgument='<% # Eval("IsActive") %>'
                                            ...
                                            <asp:ImageButton ID="ibtnEdit" runat="server" ImageUrl="~/img/details_icon2.gif"
